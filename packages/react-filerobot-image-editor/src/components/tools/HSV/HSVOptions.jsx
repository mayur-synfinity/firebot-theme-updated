...
const HSVOptions = ({ t }) => {
  ...
  return (
    <StyledHSVOptions isDarkMode={isDarkMode} isPhoneScreen={isPhoneScreen}>
      <StyledSliderContainer isDarkMode={isDarkMode} className="FIE_hue-option-wrapper">
        <StyledSliderLabel isDarkMode={isDarkMode} className="FIE_hue-option-label">
          {t('hue')}
        </StyledSliderLabel>
      ...
      <StyledSliderContainer isDarkMode={isDarkMode} className="FIE_saturation-option-wrapper">
        <StyledSliderLabel isDarkMode={isDarkMode} className="FIE_saturation-option-label">
          {t('saturation')}
        </StyledSliderLabel>
        <StyledSliderWrapper isDarkMode={isDarkMode}>
          <Slider
      ...
      <StyledSliderContainer isDarkMode={isDarkMode} className="FIE_value-option-wrapper">
        <StyledSliderLabel isDarkMode={isDarkMode} className="FIE_value-option-label">
          {t('value')}
        </StyledSliderLabel>
        <StyledSliderWrapper isDarkMode={isDarkMode}>
          <Slider
