...
const MainCanvas = () => {
  ...
  return (
    <CanvasContainer isDarkMode={providedAppContext?.isDarkMode} className="FIE_canvas-container" ref={canvasContainerRef}>
      {!providedAppContext.textIdOfEditableContent && <NodeControls />}
      {providedAppContext.isShowOriginalImage && (
        <StyledOrignalImage
          isDarkMode={providedAppContext?.isDarkMode}
