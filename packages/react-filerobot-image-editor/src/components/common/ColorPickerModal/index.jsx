...
const ColorPickerModal = ({
  ...
  return (
    ...
    >
      ...
      <ModalContent>
        <Styled.ColorPickerWrap isDarkMode={isDarkMode} hideModalTitle={hideModalTitle}>
          <ColorPicker
            onChange={onChange}
      ...
      <Styled.ModalActions isDarkMode={isDarkMode}>
        <Button className='FIE-save-modal-cancel-button' color="basic" onClick={onClose}>
          {t('cancel')}
        </Button>
