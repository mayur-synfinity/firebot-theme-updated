...
const ImageDimensionsAndDisplayToggle = ({ showBackButton, isPhoneScreen }) => {
  ...
  return (
    <StyledImageOptionsButtons isDarkMode={isDarkMode} isPhoneScreen={isPhoneScreen}>
      <StyledDimensionsLabel isDarkMode={isDarkMode} title={t('imageDimensionsHoverTitle')}>
        {`${dimensions.width} x ${dimensions.height} px`}
      </StyledDimensionsLabel>

      <StyledDimensionsButtons isDarkMode={isDarkMode}>
        <StyledSmallButton
