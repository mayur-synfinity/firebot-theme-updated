    ...
    <>
      ...
      {isModalOpened && (
        <Modal
          ...
          Icon={(props) => (
            <Image2 color={isDarkMode ? '#FFFFFF' : '#000000'} {...props} />
          )}
        ...
        >
          ...
          {isQualityAcceptable && (
            <StyledQualityWrapper isDarkMode={isDarkMode} className="FIE_save-quality-wrapper">
              <Label style={{ marginBottom: '4px' }}>{t('quality')}</Label>
              <Slider
                isDarkMode={isDarkMode}
                annotation="%"
                min={1}
          ...
          <StyledResizeOnSave isDarkMode={isDarkMode} className="FIE_save-resize-wrapper">
            <StyledResizeOnSaveLabel isDarkMode={isDarkMode}>{t('resize')}</StyledResizeOnSaveLabel>
            <Resize
